...
public class InputCSP {
	Integer startTime;
	Integer endTime;
	List<Docente> people = new ArrayList<>();
...
//						this.addDocente(memberName, memberHours, memberFreeHours, vaccinated);
//					}
//
...
//		for (Docente person : this.people) {
...
//			System.out.println();
//		}
//		for (Docente p1 : this.people) {
//			for(Docente p2 : p1.getDependencies()) {
...
//	private void addDocente(String staffName, Integer hours, List<Integer> free, Boolean vaccinated) {
//		Docente newMember = new Docente(staffName, hours, free, vaccinated);
//		List<Docente> people = this.people;
...
//	}
	...
	public List<Docente> getPeople() {
		return people;
	}

	public void setPeople(List<Docente> people) {
		this.people = people;
	}

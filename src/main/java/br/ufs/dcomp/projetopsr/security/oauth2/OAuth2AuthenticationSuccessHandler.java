...
import static br.ufs.dcomp.projetopsr.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
import br.ufs.dcomp.projetopsr.resources.exceptions.BadRequestException;
import br.ufs.dcomp.projetopsr.security.JWTUtil;
import br.ufs.dcomp.projetopsr.security.UserPrincipal;
import br.ufs.dcomp.projetopsr.security.util.CookieUtils;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        UserPrincipal usr = (UserPrincipal) authentication.getPrincipal();

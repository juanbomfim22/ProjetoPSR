...
////		restricaoRepository.saveAll(Arrays.asList(r1a, r1b, r2));
//		 
//		Usuario u1 = new Usuario(null, "juan", "juanbomfim21@gmail.com", null, be.encode("123"));
//		Usuario u2 = new Usuario(null, "juan", "juan@teste2.com", null, be.encode("123"));
//		Usuario u3 = new Usuario(null, "juan", "juan@teste3.com", null, be.encode("123"));
//
//
